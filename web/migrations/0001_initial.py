# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-08-01 14:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('fans', models.ManyToManyField(related_name='f', through='web.UserFans', to='web.UserInfo', verbose_name='粉丝')),
            ],
        ),
        migrations.AddField(
            model_name='userfans',
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.Category', verbose_name='文章分类'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
