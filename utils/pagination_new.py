...
class Pagination(object):
    ...
    def page_str(self, base_url):
        ...
        if self.current_page == 1:
            prev = '<li><a class="prev-page" href="javascript:void(0);">上一页</a></li>'
        else:
            prev = '<li><a class="prev-page" href="%s?p=%s">上一页</a></li>' % (base_url, self.current_page - 1,)
        ...
        if self.current_page == self.total_count:
            ...
            nex = '<li><a class="next-page" href="%s?p=%s">下一页</a></li>' % (base_url, self.current_page + 1,)
